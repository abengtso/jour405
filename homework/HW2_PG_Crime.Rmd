...
The crimes with lower numbers or 0 make it difficult to summarize the data because it either didn;t happen or it only happened a few times. Examples of those are the categories "homicide," "robbery residential." Accidents are also hard because they are accidents, people didn't mean to do them, so there isn't much of a story there. I thought the increase in "assault shootings" was interesting because of the decrease in "assault weapon." I also find it interesting how some crimes stay relatively the same evry month, I wonder why that is and that could be a story. 
...
```{r}
pg_crime_averages <- dplyr::mutate(pg_crime, total_incidents = Jan + Feb + Mar + Apr + May + Jun + Jul + Aug + Sep + Oct + Nov + Dec, average_incidents = total_incidents / 12)
```
...
The categories with the highest are: accident, auto stolen and theft from auto. The categories with the lowest are: homicide, B&E other and sex offense. The pattern of crime is pretty consistent, I didn't see any major changes. I definitely have questions about the auto stolen category becuase this is a very high and consistent number, why is it still so high? Are they not doing anything to help it? Same with theft for auto and theft. 
...
The crimes most likely in the summer months are assault shootings, auto stolen, homicide and robbery vehicle. B&E other and theft are the opposite, they decline in the summer months. Homicide has kow numbers already thought so it's not much of a story. I think that assault shootings and auto stolen can definitely be a story. Theft in general and the auto thefts in fact. 
...
Theft, especially auto theft, is a huge problem in Prince George's County and that's reflected in newly released crime statistics. 

The average number of auto thefts per month is a whopping 399. And that category's numbers haven't changed much at all in the past year. Prince George's County is not taking action against car theives and hundereds of people are losing their vehicles to thieve every month. 
